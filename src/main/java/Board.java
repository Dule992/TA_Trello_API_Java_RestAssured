...
public class Board extends GeneralEnvironment {
    ...
    //Method for adding card to second list
    ...
    @Test
    public void getTheListOfCard(){

        readFromFile(filePathList,"firstListID");
        boardUrl = "/1/lists/" + firstListID + "/cards?key=" + trelloKey + "&token=" + trelloToken;
